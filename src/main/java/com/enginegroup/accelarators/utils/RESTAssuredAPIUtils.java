...
public class RESTAssuredAPIUtils {
    ...
    public Response post(String endPoint, boolean urlencodedForm, String requestBody, Map<String, String> requestBodyAsMap, Map<String, String> headers) {
        Response response = null;
        RequestSpecification httpRequest;
        try {
            RestAssured.baseURI = endPoint;
    ...
    public Response post(String endPoint, boolean urlencodedForm, Map<String, String> body, Map<String, String> headers) {
        return post(endPoint, urlencodedForm, null, body, headers);
    }


    /**
     * To PUT the required body into any request and this method returns the response
     */
